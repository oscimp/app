...
with open('%s_webserver.py'%name, 'a') as f:
	...
	for elem in board_driver_array:
		...
		if elem[0] == 'redpitaya_converters_12':
			...
			f.write('\t\tself.lb_%s = gui.Label("RP12", width="20%%",height=50, margin="10px")\n'%elem[1])
			f.write('\t\tself.listView_acdc1 = gui.ListView.new_from_list(("ADC1 AC","ADC1 DC"), width=70, height=80, margin="10px")\n')
			f.write('\t\tself.listView_range1 = gui.ListView.new_from_list(("ADC1\\xa01/1","ADC1\\xa01/20"), width=80, height=80, margin="10px")\n')
			f.write('\t\tself.listView_ampl1 = gui.ListView.new_from_list(("DAC1\\xa02V","DAC1\\xa010V"), width=80, height=80, margin="10px")\n')
			f.write('\t\tself.listView_acdc2 = gui.ListView.new_from_list(("ADC2 AC","ADC2 DC"), width=70, height=80, margin="10px")\n')
			f.write('\t\tself.listView_range2 = gui.ListView.new_from_list(("ADC2\\xa01/1","ADC2\\xa01/20"), width=80, height=80, margin="10px")\n')
			f.write('\t\tself.listView_ampl2 = gui.ListView.new_from_list(("DAC2\\xa02V","DAC2\\xa010V"), width=80, height=80, margin="10px")\n')
			f.write('\t\tself.listView_extref = gui.ListView.new_from_list(("Int\\xa0Clock","Ext\\xa0Ref"), width=70, height=80, margin="10px")\n')
	...
	for elem in board_driver_array:
		...
		if elem[0] == 'redpitaya_converters_12':
			...
			f.write('\t\tliboscimp_fpga.RP_12_setAttenuator(liboscimp_fpga.CH1 ,int(lf.listView_range1=="ADC1\\xa01/20"))\n')
			f.write('\t\tself.listView_ampl1.select_by_value(lf.listView_ampl1)\n')
			f.write('\t\tliboscimp_fpga.RP_12_setGainOut(liboscimp_fpga.CH1 ,int(lf.listView_ampl1=="DAC1\\xa02V"))\n')
			...
			f.write('\t\tliboscimp_fpga.RP_12_setAttenuator(liboscimp_fpga.CH2 ,int(lf.listView_range2=="ADC2\\xa01/20"))\n')
			f.write('\t\tself.listView_ampl2.select_by_value(lf.listView_ampl2)\n')
			f.write('\t\tliboscimp_fpga.RP_12_setGainOut(liboscimp_fpga.CH2 ,int(lf.listView_ampl2=="DAC2\\xa02V"))\n')
			f.write('\t\tself.listView_extref.select_by_value(lf.listView_extref)\n')
			f.write('\t\tliboscimp_fpga.redpitaya_converters_12_ext_ref_enable("/dev/%s" ,int(lf.listView_extref=="Int\\xa0Clock"))\n'%elem[1])
		if elem[0] == 'shifterReal_dyn':
			f.write('\t\tself.sd_%s_changed(self.sd_%s, lf.%s)\n'%(elem[1], elem[1], elem[1]))
			f.write('\t\tself.sb_%s_changed(self.sb_%s, lf.%s)\n'%(elem[1], elem[1], elem[1]))
		if elem[0] == 'nco_counter':
	...
	for elem in board_driver_array:
		...
		if elem[0] == 'redpitaya_converters_12':
			...
			f.write('\t\tif int(vals.listView_acdc1=="ADC1 AC") == 1:\n')
			...
			f.write('\t\tliboscimp_fpga.RP_12_setAttenuator(liboscimp_fpga.CH1 ,int(vals.listView_range1=="ADC1\\xa01/20"))\n')
			f.write('\t\tif int(vals.listView_range1=="ADC1\\xa01/20") == 1:\n')
			...
			f.write('\t\tliboscimp_fpga.RP_12_setGainOut(liboscimp_fpga.CH1 ,int(vals.listView_ampl1=="DAC1\\xa02V"))\n')
			f.write('\t\tif int(vals.listView_ampl1=="DAC1\\xa02V") == 1:\n')
			...
			f.write('\t\tif int(vals.listView_acdc2=="ADC2 AC") == 1:\n')
			...
			f.write('\t\tliboscimp_fpga.RP_12_setAttenuator(liboscimp_fpga.CH2 ,int(vals.listView_range2=="ADC2\\xa01/20"))\n')
			f.write('\t\tif int(vals.listView_range2=="ADC2\\xa01/20") == 1:\n')
			...
			f.write('\t\tliboscimp_fpga.RP_12_setGainOut(liboscimp_fpga.CH2 ,int(vals.listView_ampl2=="DAC2\\xa02V"))\n')
			f.write('\t\tif int(vals.listView_ampl2=="DAC2\\xa02V") == 1:\n')
			...
			f.write('\t\tliboscimp_fpga.redpitaya_converters_12_ext_ref_enable("/dev/%s" ,int(vals.listView_extref=="Int\\xa0Clock"))\n'%elem[1])
			f.write('\t\tif int(vals.listView_extref=="Int\\xa0Clock") == 1:\n')

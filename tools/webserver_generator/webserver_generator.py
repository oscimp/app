...
with open('%s_webserver.py'%name, 'a') as f:
	...
	f.write('\t\tself.bt_load.onclick(self.bt_load_changed)\n')
	f.write('\t\tself.bt_save = gui.Button("Save", width=200, height=30, margin="10px")\n')
	f.write('\t\tself.bt_save.onclick(self.bt_save_changed)\n')
	...
	for elem in board_driver_array:
		...
		if elem[0] == 'add_constReal':
			...
			f.write('\t\tself.sb_%s.onchange.do(self.sb_%s_changed)\n'%(elem[1], elem[1]))
		...
		if elem[0] == 'axi_to_dac':
			...
			f.write('\t\tself.sb_ch1_%s.onchange.do(self.sb_ch1_%s_changed)\n'%(elem[1], elem[1]))
			...
			f.write('\t\tself.sb_ch2_%s.onchange.do(self.sb_ch2_%s_changed)\n'%(elem[1], elem[1]))
		...
		if elem[0] == 'pidv3_axi':
			...
			f.write('\t\tself.sb_kp_%s.onchange.do(self.sb_kp_%s_changed)\n'%(elem[1], elem[1]))
			...
			f.write('\t\tself.sb_ki_%s.onchange.do(self.sb_ki_%s_changed)\n'%(elem[1], elem[1]))
			...
			f.write('\t\tself.cb_rst_int_%s.onchange.do(self.cb_rst_int_%s_changed)\n'%(elem[1], elem[1]))
			...
			f.write('\t\tself.sb_sp_%s.onchange.do(self.sb_sp_%s_changed)\n'%(elem[1], elem[1]))
			...
			f.write('\t\tself.sb_sign_%s.onchange.do(self.sb_sign_%s_changed)\n'%(elem[1], elem[1]))
		...
		if elem[0] == 'nco_counter':
			...
			f.write('\t\tself.sb_pinc_%s.onchange.do(self.sb_pinc_%s_changed)\n'%(elem[1], elem[1]))
			...
			f.write('\t\tself.sb_poff_%s.onchange.do(self.sb_poff_%s_changed)\n'%(elem[1], elem[1]))
			f.write('\t\tself.cb_pinc_%s = gui.CheckBoxLabel("pinc", vals.cb_pinc_%s, width="5%%", margin="10px")\n'%(elem[1], elem[1]))
			f.write('\t\tself.cb_pinc_%s.onchange.do(self.cb_pinc_%s_changed)\n'%(elem[1], elem[1]))
			f.write('\t\tself.cb_poff_%s = gui.CheckBoxLabel("poff", vals.cb_poff_%s, width="5%%", margin="10px")\n'%(elem[1], elem[1]))
			f.write('\t\tself.cb_poff_%s.onchange.do(self.cb_poff_%s_changed)\n'%(elem[1], elem[1]))
			f.write('\t\tself.hbox_%s.append(self.lb_%s)\n'%(elem[1], elem[1]))

...
add_ip_and_conf convertRealToComplex r2c {
	DATA_SIZE $data_sz }
connect_intf duppl data1_out r2c dataI_in
connect_intf duppl data2_out r2c dataQ_in

add_ip_and_conf dupplComplex dupplC {
	DATA_SIZE $data_sz \
	NB_OUTPUT 2 }
connect_intf r2c data_out dupplC data_in

add_ip_and_conf dataComplex_to_ram data2ram {
	DATA_SIZE $data_sz \
	NB_INPUT 1 \
	NB_SAMPLE $nb_data }
connect_proc data2ram s00_axi 0x10000
connect_intf dupplC data1_out data2ram data1_in

add_ip_and_conf dataComplex_to_ram_pingpong data2ram_pp {
	DATA_SIZE $data_sz \
	NB_INPUT 1 \
	NB_SAMPLE $nb_data }
connect_proc data2ram_pp s00_axi 0x20000
connect_intf dupplC data2_out data2ram_pp data1_in

...
add_ip_and_conf dataReal_to_ram dataReal_to_ram_fast {
	...
	NB_INPUT {2} \
	NB_SAMPLE {1024} }
connect_proc dataReal_to_ram_fast s00_axi 0x10000
...
add_ip_and_conf nco_counter dds1_nco {
	...
	DATA_SIZE {16} \
	LUT_SIZE {12} }
connect_intf redpitaya_converters_12_0 clk_o dds1_nco ref_clk_i
connect_intf redpitaya_converters_12_0 rst_o dds1_nco ref_rst_i
...
add_ip_and_conf nco_counter dds2_nco {
	...
	DATA_SIZE {16} \
	LUT_SIZE {12} }
connect_intf redpitaya_converters_12_0 clk_o dds2_nco ref_clk_i
connect_intf redpitaya_converters_12_0 rst_o dds2_nco ref_rst_i
...
add_ip_and_conf axi_to_dac dds_range {
	DATA_SIZE {14} \
	SYNCHRONIZE_CHAN {false} }
connect_intf redpitaya_converters_12_0 clk_o dds_range ref_clk_i
connect_intf redpitaya_converters_12_0 rst_o dds_range ref_rst_i
...
add_ip_and_conf nco_counter demod1_nco {
	...
	DATA_SIZE {16} \
	LUT_SIZE {12} }
connect_intf redpitaya_converters_12_0 clk_o demod1_nco ref_clk_i
connect_intf redpitaya_converters_12_0 rst_o demod1_nco ref_rst_i
...
add_ip_and_conf nco_counter demod2_nco {
	...
	DATA_SIZE {16} \
	LUT_SIZE {12} }
connect_intf redpitaya_converters_12_0 clk_o demod2_nco ref_clk_i

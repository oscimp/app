...
with open('%s_webserver.py'%name, 'a') as f:
	...
	for elem in board_driver_array:
		...
		if elem[0] == 'nco_counter':
			...
			f.write('\t\tliboscimp_fpga.nco_counter_send_conf("/dev/%s", 125000000, ctypes.c_double(int(value)), 40, int(self.sb_poff_%s.get_value()), int(self.cb_pinc_%s.get_value()), int(self.cb_poff_%s.get_value()))\n'%(elem[1], elem[1], elem[1], elem[1]))
			...
			f.write('\t\tliboscimp_fpga.nco_counter_send_conf("/dev/%s", 125000000, ctypes.c_double(float(value)), 40, int(self.sb_poff_%s.get_value()), int(self.cb_pinc_%s.get_value()), int(self.cb_poff_%s.get_value()))\n'%(elem[1], elem[1], elem[1], elem[1]))
			...
			f.write('\t\tliboscimp_fpga.nco_counter_send_conf("/dev/%s", 125000000, ctypes.c_double(float(self.sb_pinc_%s.get_value())), 40, int(value), int(self.cb_pinc_%s.get_value()), int(self.cb_poff_%s.get_value()))\n'%(elem[1], elem[1], elem[1], elem[1]))
			...
			f.write('\t\tliboscimp_fpga.nco_counter_send_conf("/dev/%s", 125000000, ctypes.c_double(float(self.sb_pinc_%s.get_value())), 40, int(self.sb_poff_%s.get_value()), int(value == "true"), int(self.cb_poff_%s.get_value()))\n'%(elem[1], elem[1], elem[1], elem[1]))
			...
			f.write('\t\tliboscimp_fpga.nco_counter_send_conf("/dev/%s", 125000000, ctypes.c_double(float(self.sb_pinc_%s.get_value())), 40, int(self.sb_poff_%s.get_value()), int(self.cb_pinc_%s.get_value()), int(value=="true"))\n'%(elem[1], elem[1], elem[1], elem[1]))

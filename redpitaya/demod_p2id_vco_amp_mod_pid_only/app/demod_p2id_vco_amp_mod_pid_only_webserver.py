...
vals.config = "demod_p2id_vco_amp_mod_pid_only_defconf.xml"
vals.adc1_offset = 0
vals.adc2_offset = 0
vals.dac1_offset = 0
...
class MyApp(App):
	...
	def main(self):
		...
		self.lb_ki_piid1 = gui.Label("/dev/piid1/ki", width="20%", margin="10px")
	...
	def sd_ch1_mod_ampl_dds_ampl_changed(self, widget, value):
		...
		print("/dev/mod_ampl_dds_ampl", int(value))
...
start(MyApp, address="0.0.0.0", port=80, title="demod_p2id_vco_amp_mod_pid_only_webserver")

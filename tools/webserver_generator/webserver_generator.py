...
with open(f'{name}_webserver.py', 'a') as f:
	...
	f.write('\t\tself.dtext_conf_file.onchange.do(self.dtext_conf_file_changed)\n')
	f.write('\t\tself.bt_load = gui.Button("Load", width=200, height=30, margin="10px")\n')
	f.write('\t\tself.bt_load.onclick.do(self.bt_load_changed)\n')
	f.write('\t\tself.bt_save = gui.Button("Save", width=200, height=30, margin="10px")\n')
	f.write('\t\tself.bt_save.onclick.do(self.bt_save_changed)\n')
	...
	if board_name == "plutosdr":
		...
		f.write('\t\tself.sd_tx_lo.onchange.do(self.sd_tx_lo_changed)\n')
		f.write('\t\tself.sb_tx_lo = gui.SpinBox(vals.tx_lo, 0, 7000000000, 1000000, width="20%%", margin="10px")\n')
		f.write('\t\tself.sb_tx_lo.onchange.do(self.sb_tx_lo_changed)\n')
		...
		f.write('\t\tself.sd_rx_lo.onchange.do(self.sd_rx_lo_changed)\n')
		f.write('\t\tself.sb_rx_lo = gui.SpinBox(vals.rx_lo, 0, 7000000000, 1000000, width="20%%", margin="10px")\n')
		f.write('\t\tself.sb_rx_lo.onchange.do(self.sb_rx_lo_changed)\n')
	...
	for elem in board_driver_array:
		...
		if elem[0] == 'add_constReal':
			...
			f.write(f'\t\tself.sd_{elem[1]}.onchange.do(self.sd_{elem[1]}_changed)\n')
			if 'f0' not in elem[1]:
			...
			f.write(f'\t\tself.sb_{elem[1]}.onchange.do(self.sb_{elem[1]}_changed)\n')
		...
		if elem[0] == 'axi_to_dac':
			...
			f.write(f'\t\tself.sd_ch1_{elem[1]}.onchange.do(self.sd_ch1_{elem[1]}_changed)\n')
			f.write(f'\t\tself.sb_ch1_{elem[1]} = gui.SpinBox(vals.ch1_{elem[1]}, -2**(const_size-1), 2**(const_size-1)-1, 1, width="20%%", margin="10px")\n')
			f.write(f'\t\tself.sb_ch1_{elem[1]}.onchange.do(self.sb_ch1_{elem[1]}_changed)\n')
			...
			f.write(f'\t\tself.sd_ch2_{elem[1]}.onchange.do(self.sd_ch2_{elem[1]}_changed)\n')
			f.write(f'\t\tself.sb_ch2_{elem[1]} = gui.SpinBox(vals.ch2_{elem[1]}, -2**(const_size-1), 2**(const_size-1)-1, 1, width="20%%", margin="10px")\n')
			f.write(f'\t\tself.sb_ch2_{elem[1]}.onchange.do(self.sb_ch2_{elem[1]}_changed)\n')
		...
		if elem[0] == 'pidv3_axi':
			...
			f.write(f'\t\tself.sd_kp_{elem[1]}.onchange.do(self.sd_kp_{elem[1]}_changed)\n')
			f.write(f'\t\tself.sb_kp_{elem[1]} = gui.SpinBox(vals.kp_{elem[1]}, -2**(pid_coeff_size-1), 2**(pid_coeff_size-1)-1, 1, width="20%%", margin="10px")\n')
			f.write(f'\t\tself.sb_kp_{elem[1]}.onchange.do(self.sb_kp_{elem[1]}_changed)\n')
			...
			f.write(f'\t\tself.sd_ki_{elem[1]}.onchange.do(self.sd_ki_{elem[1]}_changed)\n')
			f.write(f'\t\tself.sb_ki_{elem[1]} = gui.SpinBox(vals.ki_{elem[1]}, -2**(pid_coeff_size-1), 2**(pid_coeff_size-1)-1, 1, width="20%%", margin="10px")\n')
			f.write(f'\t\tself.sb_ki_{elem[1]}.onchange.do(self.sb_ki_{elem[1]}_changed)\n')
			...
			f.write(f'\t\tself.cb_rst_int_{elem[1]}.onchange.do(self.cb_rst_int_{elem[1]}_changed)\n')
			...
			f.write(f'\t\tself.sd_sp_{elem[1]}.onchange.do(self.sd_sp_{elem[1]}_changed)\n')
			f.write(f'\t\tself.sb_sp_{elem[1]} = gui.SpinBox(vals.sp_{elem[1]}, -2**(pid_coeff_size-1), 2**(pid_coeff_size-1)-1, 1, width="20%%", margin="10px")\n')
			f.write(f'\t\tself.sb_sp_{elem[1]}.onchange.do(self.sb_sp_{elem[1]}_changed)\n')
			...
			f.write(f'\t\tself.sd_sign_{elem[1]}.onchange.do(self.sd_sign_{elem[1]}_changed)\n')
			...
			f.write(f'\t\tself.sb_sign_{elem[1]}.onchange.do(self.sb_sign_{elem[1]}_changed)\n')
		...
		if elem[0] == 'nco_counter':
			...
			f.write(f'\t\tself.sd_pinc_{elem[1]}.onchange.do(self.sd_pinc_{elem[1]}_changed)\n')
		...
		if elem[0] in ['switchReal', 'switchComplex'] :
			...
			f.write(f'\t\tself.cb_{elem[1]}.onchange.do(self.cb_{elem[1]}_changed)\n')
